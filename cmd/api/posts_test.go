...
// 	GetUserFeedFn func(ctx context.Context, userID int64) ([]store.PostsWithMetadata, error)
// }
...
// func (m *mockPostStore) GetUserFeed(ctx context.Context, userID int64) ([]store.PostsWithMetadata, error) {
// 	return m.GetUserFeedFn(ctx, userID)
// }
...
// 				},
// 				GetUserFeedFn: func(ctx context.Context, userID int64) ([]store.PostsWithMetadata, error) {
// 					return []store.PostsWithMetadata{}, nil
// 				},
// 			},
// 		},
// 	}
